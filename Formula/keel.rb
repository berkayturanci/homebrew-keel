class Keel < Formula
  ...
  url "https://github.com/berkayturanci/keel/archive/refs/tags/v1.24.2.tar.gz"
  sha256 "88c3ec43056819cd051cbe0f66e060f9caf35ac2b77b58b25a13d2628ac729d3"
  license "Apache-2.0"
  ...
  test do
    assert_match "keel 1.24.2", shell_output("#{bin}/keel version")
  end
end
