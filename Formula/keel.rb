class Keel < Formula
  ...
  url "https://github.com/berkayturanci/keel/archive/refs/tags/v1.24.1.tar.gz"
  sha256 "9a898fc07b93e28062509fe2df6697febe3df1231b3112570e8651b02dbcf18b"
  license "Apache-2.0"
  ...
  test do
    assert_match "keel 1.24.1", shell_output("#{bin}/keel version")
  end
end
