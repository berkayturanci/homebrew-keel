class Keel < Formula
  ...
  url "https://github.com/berkayturanci/keel/archive/refs/tags/v1.21.0.tar.gz"
  sha256 "b2a585602599d5b7fdf4358d231bee8439ddf7f85b0253f46008f44a14f3c54c"
  license "Apache-2.0"
  ...
  test do
    assert_match "keel 1.21.0", shell_output("#{bin}/keel version")
  end
end
