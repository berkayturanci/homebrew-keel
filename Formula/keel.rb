class Keel < Formula
  ...
  url "https://github.com/berkayturanci/keel/archive/refs/tags/v1.23.1.tar.gz"
  sha256 "350b1b4fee03a2e3b3e0a9762ec17eeb5309feab9602f814ef658e4bfed9d065"
  license "Apache-2.0"
  ...
  test do
    assert_match "keel 1.23.1", shell_output("#{bin}/keel version")
  end
end
