class Keel < Formula
  ...
  url "https://github.com/berkayturanci/keel/archive/refs/tags/v1.24.0.tar.gz"
  sha256 "7d78e38e3b453f7c8507c721fad2a2e43b2ecbd0efd06b319318e924740443c0"
  license "Apache-2.0"
  ...
  test do
    assert_match "keel 1.24.0", shell_output("#{bin}/keel version")
  end
end
